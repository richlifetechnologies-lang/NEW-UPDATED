    ...
    <AppLayout>
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
        <div className="max-w-md w-full text-center" style={{
          ...
          <h1 className="text-2xl font-bold text-foreground mb-3 font-mono tracking-wide">License Key Access</h1>
          <p className="text-muted-foreground text-sm leading-relaxed mb-6">
            Access is granted directly by the admin. Contact us to get your license key and start streaming.
          </p>
